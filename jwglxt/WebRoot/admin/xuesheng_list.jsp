...
<table width="920" border="0" cellspacing="0" cellpadding="0" background="<%=path%>/img/all_bg.jpg">
  <tr>
    <td class="border_left border_right border_bottom" height="400" valign="top" align="center"><table border="0" cellspacing="0" cellpadding="0">
      ...
      <form name="form1" method="post" action="<%=path %>/admin/xuesheng_list.jsp">
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999">
        <tr class="tabletop">
          <td height="25" colspan="12" align="center">学生管理</td>
        </tr>
        <tr class="tablemenu">
        ...
        <tr class="tabletd<%=i%2+1 %>">
          ...
          <td height="25" align="center"><%=alRow.get(3).equals("0")?"未指定班级":"<a title='点击查看详细信息' href='"+path+"/admin/banji_show.jsp?id="+banji.get(0)+"'>"+banji.get(1)+"</a>" %></td>
          <td height="25" align="center"><a title="点击查看详细信息" href="<%=path %>/admin/xuesheng_show.jsp?id=<%=alRow.get(0) %>"><%=alRow.get(4) %></a></td>
          ...
          <td height="25" align="center"><a href="<%=path %>/admin/xuesheng.jsp?mark=update&id=<%=alRow.get(0) %>">修改</a>&nbsp;&nbsp;<a href="<%=path %>/DelServlet?xuesheng=<%=alRow.get(0) %>">删除</a></td>
        </tr>
        <%} %>
        <tr class="tabletop">
          <td height="25" colspan="12" align="center"><a href="<%=path %>/admin/xuesheng.jsp?mark=add">添加学生</a></td>
        </tr>
      </table></td>
  </tr>
</table>
